...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-md bg-blue-900/20 p-1 text-muted-foreground",
      className,
    )}
    {...props}
  />
